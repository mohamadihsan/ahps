...
<!-- Validation js -->
<script src="{{ asset('assets/pages/jquery-validation/jquery.validate.js') }}"></script>
<!-- Morris Chart js -->
...
<!-- Sweat Alert -->
<script src="{{ asset('assets/pages/sweetalert/sweetalert.min.js') }}"></script>
<!-- Todo js -->
...
<!-- Custom js -->
{{-- <script type="text/javascript" src="{{ asset('assets/pages/dashboard/project-dashboard.js') }}"></script> --}}
